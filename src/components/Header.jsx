...
export const Header = () => {
  ...
  return (
    <header className="sticky">
      <nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 py-2 rounded dark:bg-gray-900 dark:border-b-1 dark:border-gray-900 ">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          {/* Logo and webapp name */}
          <Link to="/" className="flex items-center">
            <img src={Logo} className="h-6 mr-2 sm:h-9" alt="Showmate Logo" />
          ...
          <div id="mobile-nav" className="flex md:order-2">
            ...
            {/* Search and toggle in mobile view */}
            <button
